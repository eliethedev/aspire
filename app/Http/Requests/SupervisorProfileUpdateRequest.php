...
class SupervisorProfileUpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'supervisory_level' => ['nullable', 'string', 'max:255'],
            'previous_teaching_experience_years' => ['nullable', 'integer', 'min:0'],
