    ...
    'domains' => [
        [
            ...
            'indicators' => [
                ...
                ['code' => '1.7.1', 'description' => 'Effective verbal and non-verbal classroom communication strategies'],
                ['code' => '1.7.2', 'description' => 'Use effective verbal and non-verbal classroom communication strategies to support learner understanding, participation, engagement and achievement'],
                ['code' => '1.1.3', 'description' => 'Model effective applications of content knowledge within and across curriculum teaching areas'],
                ['code' => '1.3.3', 'description' => 'Promote effective strategies in the positive use of ICT to facilitate the teaching and learning process'],
                ['code' => '1.4.3', 'description' => 'Evaluate with colleagues the effectiveness of teaching strategies that promote learner achievement in literacy and numeracy'],
                ['code' => '1.5.3', 'description' => 'Develop and apply effective teaching strategies to promote critical and creative thinking, as well as other higher-order thinking skills'],
                ['code' => '1.6.3', 'description' => 'Model and support colleagues in the proficient use of Mother Tongue, Filipino and English to improve teaching and learning, as well as to develop the learners\' pride of their language, heritage and culture'],
                ['code' => '1.7.3', 'description' => 'Display a wide range of effective verbal and non-verbal classroom strategies to support learner understanding, participation, engagement and achievement'],
            ],
        ],
        [
            'number' => 2,
            ...
            'indicators' => [
                ...
                ['code' => '2.1.3', 'description' => 'Exhibit effective strategies that ensure safe and secure learning environments that promote fairness, respect and care to encourage learning'],
                ['code' => '2.2.3', 'description' => 'Exhibit effective practices to foster learning environments that promote fairness, respect and care to encourage learning'],
                ['code' => '2.3.3', 'description' => 'Work with colleagues to model and share effective techniques in the management of classroom structure to engage learners, individually or in groups, in meaningful exploration, discovery and hands-on activities within a range of physical learning environments'],
                ['code' => '2.4.3', 'description' => 'Work with colleagues to share successful strategies that sustain supportive learning environments that nurture and inspire learners to participate, cooperate and collaborate in continued learning'],
                ['code' => '2.5.3', 'description' => 'Model successful strategies and support colleagues in promoting learning environments that effectively motivate learners to work productively by assuming responsibility for their own learning'],
                ['code' => '2.6.3', 'description' => 'Exhibit effective and constructive behavior management skills by applying positive and non-violent discipline to ensure learning-focused environments'],
            ],
        ],
        [
            'number' => 3,
            ...
            'indicators' => [
                ...
                ['code' => '3.1.3', 'description' => "Work with colleagues to share differentiated, developmentally appropriate opportunities to address learners' differences in gender, needs, strengths, interests and experiences"],
                ['code' => '3.2.3', 'description' => "Exhibit a learner-centered culture that promotes success by using effective teaching strategies that respond to their linguistic, cultural, socio-economic and religious backgrounds"],
                ['code' => '3.3.3', 'description' => 'Assist colleagues to design, adapt and implement teaching strategies that are responsive to learners with disabilities, giftedness and talents'],
                ...
                ['code' => '3.5.3', 'description' => 'Develop and apply teaching strategies to address effectively the needs of learners from indigenous groups'],
            ],
        ],
        [
            'number' => 4,
            ...
            'indicators' => [
                ...
                ['code' => '4.1.3', 'description' => 'Develop and apply effective strategies in the planning and management of developmentally sequenced teaching and learning process to meet curriculum requirements and varied teaching contexts'],
                ['code' => '4.5.3', 'description' => 'Advise and guide in the selection, organization, development and use of appropriate teaching and learning resources, including ICT, to address specific learning goals'],
            ],
        ],
        [
            'number' => 5,
            ...
            'indicators' => [
                ...
                ['code' => '5.1.3', 'description' => 'Work collaboratively with colleagues to review the design, selection, organization and use of a range of effective diagnostic, formative and summative assessment strategies consistent with curriculum requirements'],
                ['code' => '5.3.3', 'description' => 'Use effective strategies for providing timely, accurate and constructive feedback to encourage learners to reflect on and improve their own learning'],
            ],
        ],
        [
            'number' => 6,
