...
<body class="antialiased font-sans light-bg min-h-screen flex flex-col">
    ...
    <div class="w-full max-w-md glass-card rounded-2xl p-6 sm:p-8 md:p-10 card-padding">
        ...
        @if (session('status'))
            <div class="mb-6 bg-green-50 dark:bg-green-500/10 border border-green-200 dark:border-green-800 rounded-xl p-4">
                <div class="flex items-start">
                    <svg class="w-5 h-5 text-green-500 dark:text-green-400 mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
