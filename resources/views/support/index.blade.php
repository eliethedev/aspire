...
<div class="mock-wrap max-w-7xl mx-auto px-1 py-1">
    <div class="mock-topbar"><div class="mock-crumbs">Support <span>/</span> <b>My Messages</b></div><div class="mock-actions"><div>
...
<div class="mock-title"><div><h1>My Messages</h1><p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Messages you have sent to the administrators.</p></div><time>{{ now()->format('l, F j, Y') }}</time></div>
