    ...
    <div class="bg-white dark:bg-gray-900 rounded-xl shadow-sm glass-card p-6">
        <form method="GET" action="{{ route('admin.teachers.index') }}" class="space-y-4">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div>
                    <label for="school_id" class="block text-sm font-medium text-dark  dark:text-white mb-1">School</label>
                ...
                <div class="flex items-end">
                    <button type="submit" 
                            class="w-full px-4 py-2 bg-slate-600 text-dark  dark:text-white rounded-lg hover:bg-slate-700 transition-colors">
                        Filter
                    </button>
                </div>
            </div>
            ...
            <div class="flex items-center mt-2">
                <a href="{{ route('admin.teachers.index') }}" class="text-sm text-blue-600 dark:text-blue-400 hover:text-blue-800">
                    Clear filters
                </a>
            </div>
            @endif
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm">
                            <div class="flex items-center space-x-2">
                                ...
                                <a href="{{ route('admin.teachers.edit', $teacher) }}" 
                                   class="text-indigo-600 dark:text-indigo-400 hover:text-indigo-800 dark:text-gray-300" title="Edit">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <tr>
                        <td colspan="7" class="px-6 py-12 text-center">
                            <div class="text-dark">
                                ...
                                <a href="{{ route('admin.teachers.create') }}" class="mt-2 inline-flex text-blue-600 dark:text-blue-400 hover:text-blue-800">
