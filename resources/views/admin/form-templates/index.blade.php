...
<div class="max-w-7xl mx-auto px-4 space-y-4">
    <div class="bg-white rounded-xl shadow-sm p-6">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Observation Form Templates</h1>
                <p class="text-gray-500 mt-1">Manage dynamic form templates for classroom observations.</p>
            </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        @forelse($templates as $template)
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 template-card {{ $template->is_active ? 'ring-2 ring-indigo-400' : '' }}">
                <div class="p-5">
                    ...
                    <div class="flex items-center gap-2">
                        <a href="{{ route('admin.form-templates.edit', $template) }}"
                           class="flex-1 text-center px-3 py-1.5 text-sm font-medium text-indigo-600 bg-indigo-50 hover:bg-indigo-100 rounded-lg transition-colors">Edit</a>
                        @if(!$template->is_active)
        ...
        @empty
            <div class="col-span-full text-center py-12 bg-white rounded-xl shadow-sm">
                ...
                <p class="text-gray-500 font-medium">No form templates yet.</p>
                <p class="text-sm text-gray-400 mt-1">Create your first template to define observation forms dynamically.</p>
