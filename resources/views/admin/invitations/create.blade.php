...
<div class="max-w-5xl mx-auto px-6 space-y-6">
    ...
    <div class="bg-green-50 border border-green-200 rounded-xl p-4 flex items-start">
        ...
        <div class="flex-1">
            ...
            <div class="mt-3 flex space-x-3">
                <a href="{{ route('admin.invitations.create') }}" class="text-sm text-green-700 hover:text-green-800 font-medium">
                    Send Another Invitation
                </a>
                <span class="text-green-300">|</span>
                <a href="{{ route('admin.users.index') }}" class="text-sm text-green-700 hover:text-green-800 font-medium">
                    View Users
                </a>
            </div>
        </div>
    ...
    <!-- Form -->
    <div class="bg-white rounded-xl shadow-sm border glass-card">
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center">
                        ...
                        <div id="step-2-indicator" class="flex items-center">
                            ...
                            <span class="ml-2 text-sm font-medium text-gray-500">Role Details</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div id="content-role" class="tab-content hidden">
                    <div class="space-y-6">
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                                <label class="relative cursor-pointer">
                                    <input type="radio" name="role" value="teacher" required
                                           ...
                                           class="peer sr-only">
                                    <div class="p-4 border-2 border-gray-200 rounded-lg peer-checked:border-blue-500 peer-checked:bg-blue-50 transition-all hover:border-gray-300">
                        ...
                        <div>
                            ...
                            <p id="school-helper" class="mt-1 text-xs text-gray-500">Required for Teacher, Supervisor, and School Head roles</p>
                            @error('school_id')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-xs text-gray-500">This message will be included in the invitation email sent to the user.</p>
            ...
            <div class="px-6 py-4 bg-gray-50 border-t border-gray-200 rounded-b-xl flex items-center justify-between">
                <div class="flex items-center space-x-3">
                    <a href="{{ route('admin.invitations.index') }}"
                       class="px-4 py-2 text-dark bg-white border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors">
                        Cancel
                    </a>
                    <button type="button" id="backBtn" onclick="goToStep(1)" class="hidden px-4 py-2 text-dark bg-white border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors">
...
function goToStep(step) {
    ...
    if (step === 1) {
        step1Indicator.querySelector('div').classList.remove('bg-gray-200', 'text-gray-500');
        ...
        step1Indicator.querySelector('span').classList.add('text-blue-600');

        step2Indicator.querySelector('div').classList.remove('bg-blue-600', 'text-white');
        step2Indicator.querySelector('div').classList.add('bg-gray-200', 'text-gray-500');
        ...
        step1Indicator.querySelector('div').classList.add('bg-green-500', 'text-white');
        ...
        step2Indicator.querySelector('div').classList.remove('bg-gray-200', 'text-gray-500');
