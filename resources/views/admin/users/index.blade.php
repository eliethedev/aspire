    ...
    <div class="bg-dark rounded-xl shadow-sm border glass-card p-6">
        <form method="GET" action="{{ route('admin.users.index') }}" class="space-y-4">
            ...
            <div class="flex items-center">
                <a href="{{ route('admin.users.index') }}" class="text-sm text-blue-600 dark:text-blue-400 hover:text-blue-800">
                    Clear filters
                </a>
            </div>
            @endif
                        ...
                        <td class="px-6 py-4 darkspace-nowrap text-sm">
                            <div class="flex items-center space-x-2">
                                ...
                                <a href="{{ route('admin.users.edit', $user) }}" 
                                   class="text-indigo-600 dark:text-indigo-400 hover:text-indigo-800" title="Edit">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
                                    </svg>
                                </a>
                                <form method="POST" action="{{ route('admin.users.destroy', $user) }}" 
                                      onsubmit="return confirm('Are you sure you want to deactivate {{ $user->name }}? They will no longer be able to sign in, but their records stay intact.')">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="text-red-600 dark:text-red-400 hover:text-red-800" title="Deactivate">
                    ...
                    <tr>
                        <td colspan="6" class="px-6 py-12 text-center">
                            <div class="text-dark dark:text-gray-400">
                                ...
                                <a href="{{ route('admin.users.create') }}" class="mt-2 inline-flex text-blue-600 dark:text-blue-400 hover:text-blue-800">
