    ...
    <div class="bg-white rounded-xl shadow-sm glass-card p-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-gray-500 mt-1">Create and send announcements to users.</p>
            </div>
    ...
    <div class="bg-white rounded-xl shadow-sm glass-card p-6">
        <form method="GET" action="{{ route('admin.announcements.index') }}" class="space-y-4">
            ...
            <div class="flex items-center mt-2">
                <a href="{{ route('admin.announcements.index') }}" class="text-sm text-indigo-600 hover:text-indigo-800">
                    Clear filters
                </a>
            </div>
            @endif
                ...
                <tbody class="divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50 text-gray-900">
                        <td class="px-6 py-4">
                            ...
                            <div class="text-sm text-gray-500 truncate max-w-xs">{{ Str::limit($announcement->message, 80) }}</div>
                        </td>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm text-gray-500">{{ $announcement->sender?->name ?? 'N/A' }}</div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm text-gray-500">
                    ...
                    <tr>
                        <td colspan="7" class="px-6 py-12 text-center">
                            ...
                            <p class="mt-2 text-sm text-gray-500">No announcements found.</p>
                            <a href="{{ route('admin.announcements.create') }}" class="mt-3 inline-flex items-center text-sm text-indigo-600 hover:text-indigo-500">
