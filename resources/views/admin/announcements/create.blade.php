...
<div class="mock-wrap max-w-7xl mx-auto px-1 py-1">
    <div class="mock-topbar"><div class="mock-crumbs">Admin <span>/</span> <b>Create Announcement</b></div><div class="mock-actions"><a href="{{ route('admin.announcements.index') }}"
               class="mock-btn">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"/>
                </svg>
            </a></div></div>
<div class="mock-title"><div><h1>Create Announcement</h1><p class="text-gray-500 dark:text-gray-400 dark:text-gray-500 mt-1">Compose a new announcement and choose how to deliver it.</p>
    ...
    <section class="mock-panel"><form method="POST" action="{{ route('admin.announcements.store') }}" class="space-y-6">
        @csrf
