    ...
    <div class="flex items-center justify-between mb-8">
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-gray-500 mt-1">Compose a new announcement and choose how to deliver it.</p>
            </div>
        </div>
    </div>
            ...
            <div class="space-y-5">
                <div>
                    ...
                    <div class="flex items-center justify-between mt-1.5">
                        ...
                        @else
                            <p class="text-xs text-gray-400">A clear, concise title for your announcement.</p>
                        @enderror
                    </div>
                </div>
                ...
                <div>
                    ...
                    @error('link')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                    <p class="mt-1 text-xs text-gray-400">Recipients will see a "View Details" button linking to this URL.</p>
                </div>
            </div>
        </div>
