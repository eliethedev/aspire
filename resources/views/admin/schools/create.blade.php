...
<div class="max-w-4xl mx-auto px-4 sm:px-6">
    ...
    <form method="POST" action="{{ route('admin.schools.store') }}" class="space-y-6">
            ...
            <div class="space-y-4">
                ...
                <label class="flex items-center gap-3 p-4 rounded-lg border border-gray-200 dark:border-gray-700 hover:border-gray-300 hover:bg-gray-50 dark:bg-gray-800 transition-all cursor-pointer">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-500 dark:text-gray-400">Set trial period for new schools</p>
                    </div>
                </label>
        ...
        <div class="flex items-center justify-between">
            <a href="{{ route('admin.schools.index') }}"
               class="px-5 py-2.5 text-sm font-medium text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:text-white transition-colors">
                Cancel
            </a>
            <button type="submit"
