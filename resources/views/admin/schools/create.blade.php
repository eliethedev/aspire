...
<div class="max-w-4xl mx-auto px-4 sm:px-6">
    <div class="flex items-center justify-between mb-8">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h1 class="text-2xl font-bold text-gray-900 dark:text-gray-100">Create New School</h1>
                <p class="text-gray-500 dark:text-gray-400 dark:text-gray-500 mt-1">Add a new educational institution to the system.</p>
            </div>
        </div>
    </div>
    ...
    <form method="POST" action="{{ route('admin.schools.store') }}" class="space-y-6">
        ...
        <div class="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm p-6">
            <div class="flex items-center gap-2 mb-6">
                ...
                <h2 class="text-lg font-semibold text-gray-900 dark:text-gray-100">School Information</h2>
            </div>
        ...
        <div class="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm p-6">
            <div class="flex items-center gap-2 mb-6">
                ...
                <h2 class="text-lg font-semibold text-gray-900 dark:text-gray-100">Domain Settings</h2>
            </div>
        ...
        <div class="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm p-6">
            <div class="flex items-center gap-2 mb-6">
                ...
                <h2 class="text-lg font-semibold text-gray-900 dark:text-gray-100">School Status</h2>
            </div>

            <div class="space-y-4">
                <label class="flex items-center gap-3 p-4 rounded-lg border border-gray-200 dark:border-gray-700 hover:border-gray-300 hover:bg-gray-50 dark:bg-gray-800 transition-all cursor-pointer">
                    <input type="checkbox" id="is_active" name="is_active" value="1" 
                           class="w-4 h-4 rounded border-gray-300 text-indigo-600 dark:text-indigo-400 focus:ring-indigo-500"
                           {{ old('is_active') ? 'checked' : '' }}>
                    <div>
                        <span class="text-sm font-medium text-gray-900 dark:text-gray-100">Active School</span>
                        <p class="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-500">Enable this school for user access and functionality</p>
                    </div>
                </label>
                ...
                <label class="flex items-center gap-3 p-4 rounded-lg border border-gray-200 dark:border-gray-700 hover:border-gray-300 hover:bg-gray-50 dark:bg-gray-800 transition-all cursor-pointer">
                    ...
                    <div>
                        <span class="text-sm font-medium text-gray-900 dark:text-gray-100">Trial Period</span>
                        <p class="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-500">Set trial period for new schools</p>
                    </div>
                </label>
                ...
                <div id="trial_date_wrapper" class="ml-9 {{ old('has_trial') ? '' : 'hidden' }}">
                    ...
                    <input type="date" id="trial_ends_at" name="trial_ends_at" value="{{ old('trial_ends_at') }}"
                           class="w-full px-4 py-2.5 rounded-lg border text-gray-900 dark:text-gray-100 text-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition-shadow max-w-xs
        ...
        <div class="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm p-6">
            <div class="flex items-center gap-2 mb-6">
                ...
                <h2 class="text-lg font-semibold text-gray-900 dark:text-gray-100">School Settings</h2>
            </div>
            ...
            <div>
                ...
                <textarea id="settings" name="settings" rows="6" 
                          class="w-full px-4 py-3 rounded-lg border text-gray-900 dark:text-gray-100 text-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition-shadow font-mono
