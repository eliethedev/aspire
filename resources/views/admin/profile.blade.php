    ...
    <form method="POST" action="{{ route('admin.profile.update') }}">
        ...
        <div class="flex flex-col md:flex-row gap-6">
                ...
                <div class="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm p-2">
                    <nav class="space-y-0.5">
                        ...
                        <button type="button" @click="activeTab = 'admin'"
                                class="profile-tab w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm text-left"
                                :class="activeTab === 'admin' ? 'active' : 'text-gray-600 dark:text-gray-400'">
            ...
            <div class="flex-1 min-w-0">
                ...
                <!-- Administrative Details -->
                <div x-show="activeTab === 'admin'" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0 translate-y-2" x-transition:enter-end="opacity-100 translate-y-0"
                     class="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm p-6">
                    <h2 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-1">Administrative Details</h2>
                    <p class="text-sm text-gray-500 dark:text-gray-400 mb-6">Your professional and administrative information.</p>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                        ...
                        <div>
                            ...
                            <x-text-input id="position_title" name="position_title" type="text" class="mt-1 block w-full" :value="old('position_title', $user->profile?->position_title)" />
                        ...
                        <div>
                            ...
                            <x-text-input id="office_department" name="office_department" type="text" class="mt-1 block w-full" :value="old('office_department', $user->profile?->office_department)" />
                ...
                <div class="flex items-center gap-4 mt-6">
                    ...
                    <a href="{{ route('admin.dashboard') }}" class="text-sm text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 underline">Cancel</a>
                </div>
