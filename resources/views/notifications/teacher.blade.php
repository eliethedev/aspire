...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-gray-900">Teacher Notifications</h1>
        <p class="mt-1 text-sm text-gray-500">View your observation and evaluation notifications</p>
    </div>
