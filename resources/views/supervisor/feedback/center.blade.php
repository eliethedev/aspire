...
<div class="max-w-7xl mx-auto px-4 sm:px-6">
    ...
    @forelse($observations as $observation)
        ...
        @endphp
        <div class="fb-card bg-white rounded-xl border border-gray-100 shadow-sm p-5 mb-4">
            <div class="flex flex-col sm:flex-row sm:items-center gap-4">
                    ...
                    <div class="min-w-0">
                        <div class="flex items-center gap-2 flex-wrap">
                            ...
                            <span class="inline-flex items-center px-2 py-0.5 rounded text-[11px] font-medium
                                {{ $observation->status === 'completed' ? 'bg-green-100 text-green-700' : 'bg-amber-100 text-amber-700' }}">
                ...
                <div class="flex items-center gap-4 text-sm shrink-0">
                    <!-- Feedback summary -->
                    <div class="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-gray-50">
