...
<div class="max-w-5xl mx-auto px-4 sm:px-6">
    ...
    <nav class="mb-6 text-sm">
        <ol class="flex items-center gap-2 text-gray-500">
            ...
            <li><svg class="w-3 h-3" fill="currentColor" viewBox="0 0 20 20"><path d="M7.21 14.77a.75.75 0 01.02-1.06L11.168 10 7.23 6.29a.75.75 0 111.04-1.08l4.5 4.25a.75.75 0 010 1.08l-4.5 4.25a.75.75 0 01-1.06-.02z"/></svg></li>
            <li><a href="{{ route('supervisor.feedback.index', $observation) }}" class="hover:text-indigo-600 transition-colors">Feedback</a></li>
            <li><svg class="w-3 h-3" fill="currentColor" viewBox="0 0 20 20"><path d="M7.21 14.77a.75.75 0 01.02-1.06L11.168 10 7.23 6.29a.75.75 0 111.04-1.08l4.5 4.25a.75.75 0 010 1.08l-4.5 4.25a.75.75 0 01-1.06-.02z"/></svg></li>
            <li class="text-gray-900 font-medium">Edit Feedback</li>
        </ol>
    </nav>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-xl border border-gray-100 shadow-sm p-6">
                <div class="flex items-center gap-2.5 mb-4">
                    ...
                    @if($feedback->generated_by === 'ai')
                        <span class="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-medium bg-purple-100 text-purple-700">AI-Generated</span>
                    @endif
                </div>
                <textarea name="analysis" rows="6"
                          class="w-full px-4 py-3 rounded-lg border border-gray-300 text-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 text-sm"
            ...
            <div class="bg-white rounded-xl border border-gray-100 shadow-sm p-6">
                <div class="flex items-center gap-2.5 mb-4">
                    ...
                    <h2 class="text-lg font-semibold text-gray-900">Strengths</h2>
                </div>
                    ...
                    @foreach($strengths as $i => $strength)
                        <div class="list-input-item flex items-center gap-2">
                            <input type="text" name="strengths[]" value="{{ $strength }}"
                                   class="flex-1 px-3 py-2 rounded-lg border border-gray-300 text-gray-900 focus:outline-none focus:ring-2 focus:ring-green-500 text-sm"
                ...
                <button type="button" onclick="addListItem('strengths-list', 'strengths[]', 'Enter a strength...')"
                        class="mt-3 inline-flex items-center gap-1.5 text-sm text-green-600 hover:text-green-700 font-medium transition-colors">
            ...
            <div class="bg-white rounded-xl border border-gray-100 shadow-sm p-6">
                <div class="flex items-center gap-2.5 mb-4">
                    ...
                    <h2 class="text-lg font-semibold text-gray-900">Areas for Improvement</h2>
                </div>
                    ...
                    @foreach($afiItems as $i => $item)
                        <div class="list-input-item flex items-center gap-2">
                            <input type="text" name="areas_for_improvement[]" value="{{ $item }}"
                                   class="flex-1 px-3 py-2 rounded-lg border border-gray-300 text-gray-900 focus:outline-none focus:ring-2 focus:ring-amber-500 text-sm"
                ...
                <button type="button" onclick="addListItem('afi-list', 'areas_for_improvement[]', 'Enter an area for improvement...')"
                        class="mt-3 inline-flex items-center gap-1.5 text-sm text-amber-600 hover:text-amber-700 font-medium transition-colors">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M12 6v6m0 0v6m0-6h6m-6 0H6"/></svg>
                    ...
                    @foreach($recs as $i => $rec)
                        <div class="list-input-item flex items-center gap-2">
                            <input type="text" name="recommendations[]" value="{{ $rec }}"
                                   class="flex-1 px-3 py-2 rounded-lg border border-gray-300 text-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 text-sm"
