...
<div class="max-w-7xl mx-auto px-3 py-3 sm:px-1">
    ...
    <nav aria-label="Breadcrumb" class="mb-4 sm:mb-6 text-sm">
        <ol class="flex flex-wrap items-center gap-x-2 gap-y-1 text-gray-500 dark:text-gray-400">
            ...
            <li class="text-gray-900 dark:text-gray-100 font-medium truncate max-w-[200px] sm:max-w-none" aria-current="page">Pre-Observation Conversation</li>
        </ol>
    </nav>
    ...
    <div class="mb-5 sm:mb-6">
        <h1 class="text-xl sm:text-2xl font-bold tracking-tight text-gray-900 dark:text-gray-100">Pre-Observation Conversation</h1>
        <p class="mt-1 flex flex-wrap items-center gap-x-2 gap-y-1 text-sm text-gray-500 dark:text-gray-400">
            <span class="font-medium text-gray-700 dark:text-gray-300">{{ $observation->observee->user->name ?? 'Unknown' }}</span>
