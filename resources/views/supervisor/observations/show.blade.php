...
<div class="max-w-7xl mx-auto px-6">
    ...
    <div class="space-y-6">
        ...
        <div class="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-100 p-6">
            ...
            <div class="mt-4 flex items-center gap-3">
                <a href="{{ route('supervisor.observations.epoc', $observation) }}" class="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-purple-600 hover:text-purple-700 bg-purple-50 hover:bg-purple-100 dark:bg-purple-900/20 dark:hover:bg-purple-900/30 rounded-lg transition-colors">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/></svg>
                    Edit Enhanced Post-Observation Conference Evaluation
                </a>
                <a href="{{ route('supervisor.observations.epoc.download', $observation) }}" class="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-gray-700 hover:text-gray-800 bg-gray-100 hover:bg-gray-200 dark:bg-gray-800 dark:hover:bg-gray-700 dark:text-gray-300 rounded-lg transition-colors">
        ...
        <div class="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-dashed border-purple-200 dark:border-purple-800 p-6 text-center">
            <div class="w-12 h-12 rounded-full bg-purple-100 dark:bg-purple-900/30 flex items-center justify-center mx-auto mb-3">
            ...
            <h3 class="text-sm font-semibold text-gray-900 dark:text-gray-100 mb-1">Enhanced Post-Observation Conference Evaluation Not Yet Completed</h3>
            <p class="text-xs text-gray-500 dark:text-gray-400 mb-3">Evaluate the School Head's post-observation conference practices.</p>
            <a href="{{ route('supervisor.observations.epoc', $observation) }}" class="inline-flex items-center gap-2 px-5 py-2.5 bg-purple-600 hover:bg-purple-700 text-white rounded-lg font-medium text-sm transition-colors">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"/></svg>
                Complete Enhanced Post-Observation Conference Evaluation
            </a>
        </div>
        @endif
    ...
    <div class="mt-8 mb-4 flex flex-wrap justify-center gap-4">
    ...
    <div class="flex flex-wrap justify-center gap-4">
        ...
        @if($observation->canFinalize())
            <form method="POST" action="{{ route('supervisor.observations.finalize', $observation) }}" onsubmit="return confirm('Finalize this observation? The teacher will be notified and can view the results.')">
                @csrf
                <button type="submit"
                    class="inline-flex items-center gap-3 px-8 py-3 bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl font-semibold shadow-lg shadow-emerald-600/20 transition-all hover:shadow-xl hover:shadow-emerald-600/30">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
    ...
    <div class="mt-6 flex flex-wrap justify-center gap-3">
        <a href="{{ route('supervisor.observations.report-pdf', $observation) }}"
        ...
        <a href="{{ route('supervisor.observations.indicator-trends', $observation) }}"
        ...
        <a href="{{ route('supervisor.observations.progress-comparison', $observation) }}"
        ...
        <a href="{{ route('supervisor.observations.pd-recommendations', $observation) }}"
        ...
        <div class="flex items-center justify-between gap-4 flex-wrap">
            <div>
                ...
                <p class="text-xs text-gray-400 dark:text-gray-500 mt-1">
                    Generated on {{ \Carbon\Carbon::parse($observation->cot_document_generated_at)->format('M d, Y \a\t h:i A') }}
                </p>
                @endif
            </div>
            <div class="flex flex-wrap gap-3">
                ...
                <a target="_blank" href="{{ route('supervisor.observations.cot-document.preview', $observation) }}" 
