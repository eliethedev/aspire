    ...
    <div class="bg-white rounded-xl shadow-sm glass-card p-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-white mt-1">Here is your supervision overview.</p>
            </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div class="bg-white rounded-xl shadow-sm glass-card p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-sm font-medium text-white/80">Pending Observations</p>
        ...
        <div class="bg-white rounded-xl shadow-sm glass-card p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-sm font-medium text-white/80">Completed Observations</p>
        ...
        <div class="bg-white rounded-xl shadow-sm glass-card p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-sm font-medium text-white/80">Average COT Score</p>
    ...
    <div class="bg-white rounded-xl shadow-sm glass-card p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <a href="{{ route('supervisor.observations.create') }}" class="flex items-center p-4 rounded-lg bg-blue-500/10 hover:bg-blue-500/20 transition-colors">
                ...
                <span class="text-white font-medium">New Observation</span>
            </a>
            <a href="{{ route('supervisor.teachers.index') }}" class="flex items-center p-4 rounded-lg bg-green-500/10 hover:bg-green-500/20 transition-colors">
                ...
                <span class="text-white font-medium">View Teachers</span>
            </a>
            <a href="{{ route('supervisor.reports.index') }}" class="flex items-center p-4 rounded-lg bg-purple-500/10 hover:bg-purple-500/20 transition-colors">
                ...
                <span class="text-white font-medium">View Reports</span>
            </a>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm glass-card p-6">
                    ...
                    <div class="flex items-center justify-between p-4 rounded-lg bg-white/5">
                        <div class="flex items-center space-x-4">
                            ...
                            <div>
                                ...
                                <p class="text-white/60 text-sm">{{ $observation->observation_date->format('M d, Y') }} - {{ $observation->status }}</p>
                            </div>
                        </div>
        ...
        @else
            <div class="text-center py-8">
                <p class="text-white/60">No recent activity to display.</p>
            </div>
        @endif
    </div>
</div>
