...
@section('message', 'We couldn\'t complete your request right now. Please try again in a moment. If the problem continues, contact your administrator.')
@section('iconBg', 'bg-red-50 dark:bg-red-500/10 border border-red-100 dark:border-red-500/20')
@section('icon')
