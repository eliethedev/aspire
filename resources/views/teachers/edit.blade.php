...
<div class="max-w-7xl mx-auto px-6 py-8 space-y-8">
    ...
    <div class="bg-white rounded-xl shadow-sm border glass-card p-6">
        <div class="flex items-center">
            ...
            <div>
                ...
                <p class="text-white mt-1">{{ $teacher->user->name }}</p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border glass-card p-6 mb-6">
        <div class="flex items-center space-x-4">
            ...
            <div>
                <h3 class="text-lg font-medium text-white">{{ $teacher->user->name }}</h3>
                <p class="text-sm text-white">{{ $teacher->user->email }}</p>
    ...
    <div class="bg-white rounded-xl shadow-sm border glass-card p-6">
        <form method="POST" action="{{ route('teachers.update', $teacher) }}" class="space-y-8">
            ...
            <!-- Password Section -->
            <div>
                <h2 class="text-lg font-medium text-white mb-4 pb-2 border-b glass-card p-4 rounded-lg">Change Password</h2>
            ...
            <!-- Teacher Information -->
            <div>
                <h2 class="text-lg font-medium text-white mb-4 pb-2 border-b glass-card p-4 rounded-lg">Teacher Information</h2>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div>
                        ...
                        <input type="number" id="years_of_service" name="years_of_service" 
                               ...
                               class="w-full px-3 py-2 border text-white glass-card rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500
    ...
    <div class="bg-white rounded-xl shadow-sm border glass-card p-6 mt-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-white mt-1">Once you delete a teacher, You can't restore it.</p>
            </div>
            <form method="POST" 
