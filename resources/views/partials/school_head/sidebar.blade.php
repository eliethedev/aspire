...
<aside class="w-58 bg-white shadow-sm border-r border-slate-200 min-h-screen">
    <nav class="mt-8 px-4">
        <ul class="space-y-2">
            <!-- Dashboard -->
            <li>
                <a href="{{ route('school_head.dashboard') }}" 
                   class="sidebar-link flex items-center px-4 py-3 rounded-lg text-slate-700 {{ request()->routeIs('school_head.dashboard') ? 'active' : '' }}">
