...
@endphp
<div class="mb-3 min-w-0 rounded-lg border border-indigo-100 dark:border-indigo-900/40 bg-indigo-50/60 dark:bg-indigo-900/10 px-3 py-2.5">
    <div class="flex flex-col items-stretch gap-2 sm:flex-row sm:flex-wrap sm:items-center sm:gap-x-3 sm:gap-y-2">
        <span id="ai-engine-badge" class="inline-flex min-w-0 max-w-full items-center gap-1.5 text-[11px] font-semibold text-indigo-700 dark:text-indigo-300" title="AI engine currently powering this assistant">
            <svg class="w-3.5 h-3.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z"/></svg>
            <span id="ai-engine-badge-text" class="truncate">{{ $currentIndicator }}</span>
        </span>
        <label class="inline-flex min-w-0 items-center gap-1.5 text-[11px] font-medium text-gray-500 dark:text-gray-400">
            <span class="shrink-0">Engine</span>
            <select id="ai-engine-mode"
                    class="min-w-0 max-w-full flex-1 sm:flex-none text-[11px] font-semibold rounded-md border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-200 px-1.5 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500">
        ...
        <span class="text-[11px] leading-snug text-gray-400 dark:text-gray-500">Auto matches the engine to the lesson subject &amp; goals.</span>
    </div>
</div>
<script>
(function () {
