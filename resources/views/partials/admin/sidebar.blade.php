            ...
            <li class="mb-1" data-mks-group="standards cot templates ppst instruments">
                ...
                <ul x-show="!$store.sidebar.isCollapsed() ? standardsOpen : true" class="space-y-0.5 mt-0.5">
                   <li>
                    ...
                    <li>
                        <a data-mks="epoc templates domains school head evaluation" href="{{ route('admin.epoc-templates.index') }}"
                           class="sidebar-link-hover flex items-center px-3 py-2 rounded-xl text-sm text-gray-600 dark:text-gray-400 {{ request()->routeIs('admin.epoc-templates.*') ? 'sidebar-link-active icon-reports' : '' }}"
                           :class="$store.sidebar.isCollapsed() ? 'justify-center px-2' : ''">
                            <span class="sidebar-icon-wrap icon-reports ml-5" :class="$store.sidebar.isCollapsed() ? '' : 'mr-3'">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"/>
                            ...
                            <span x-show="!$store.sidebar.isCollapsed()" class="font-medium">EPOC Templates</span>
                        </a>
                    </li>
                </ul>
            </li>
                ...
                <ul x-show="!$store.sidebar.isCollapsed() ? managementOpen : true" class="space-y-0.5 mt-0.5">
                    ...
                    <li>
                        <a data-mks="teachers faculty" href="{{ route('admin.teachers.index') }}"
                           ...
                           :class="$store.sidebar.isCollapsed() ? 'justify-center px-2' : ''">
                            <span class="sidebar-icon-wrap icon-profile ml-5" :class="$store.sidebar.isCollapsed() ? '' : 'mr-3'">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <ul x-show="!$store.sidebar.isCollapsed() ? otherOpen : true" class="space-y-0.5 mt-0.5">
                    ...
                    <li>
                        <a data-mks="announcements news broadcast" href="{{ route('admin.announcements.index') }}"
                           ...
                           :class="$store.sidebar.isCollapsed() ? 'justify-center px-2' : ''">
                            <span class="sidebar-icon-wrap icon-announcements ml-5" :class="$store.sidebar.isCollapsed() ? '' : 'mr-3'">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5.882V19.24a1.76 1.76 0 01-3.417.592l-2.147-6.15M18 13a3 3 0 100-6M5.436 13.683A4.001 4.001 0 017 6h1.832c4.1 0 7.625-1.234 9.168-3v14c-1.543-1.766-5.067-3-9.168-3H7a3.988 3.988 0 01-1.564-.317z"/>
                                </svg>
                            </span>
                    ...
                    <li>
                        <a data-mks="audit logs activity history" href="{{ route('admin.audit-logs.index') }}"
                           ...
                           :class="$store.sidebar.isCollapsed() ? 'justify-center px-2' : ''">
                            <span class="sidebar-icon-wrap icon-audit ml-5" :class="$store.sidebar.isCollapsed() ? '' : 'mr-3'">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                                </svg>
                            </span>
                    ...
                    <li>
                        <a data-mks="ai settings artificial intelligence configuration" href="{{ route('admin.ai.index') }}"
                           ...
                           :class="$store.sidebar.isCollapsed() ? 'justify-center px-2' : ''">
                            <span class="sidebar-icon-wrap icon-ai ml-5" :class="$store.sidebar.isCollapsed() ? '' : 'mr-3'">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <li>
                        <a data-mks="ai usage cost billing tokens" href="{{ route('admin.ai-usage.index') }}"
                           ...
                           :class="$store.sidebar.isCollapsed() ? 'justify-center px-2' : ''">
                            <span class="sidebar-icon-wrap icon-ai-usage ml-5" :class="$store.sidebar.isCollapsed() ? '' : 'mr-3'">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
