...
<style>
    ...
    /* ── Folder trees ── */
    .mks-tree{margin-left:17px;border-left:1px solid rgba(148,163,184,.3);padding-left:4px}
    .dark .mks-tree{border-left-color:#1e2530}
    .mks-file-dot{width:5px;height:5px;border-radius:50%;background:#94a3b8;flex:none}
    .dark .mks-file-dot{background:#5c6672}
    ...
    .mks-folder-ico{color:#58a6ff;flex:none}
