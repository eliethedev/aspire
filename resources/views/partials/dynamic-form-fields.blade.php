...
@if($templateFields->isNotEmpty())
    <div class="bg-gradient-to-r from-indigo-50 to-purple-50 rounded-xl p-6 border border-indigo-100">
        <div class="flex items-center gap-2 mb-4">
            ...
            <h3 class="text-sm font-semibold text-indigo-700 uppercase tracking-wider">Dynamic Form Fields</h3>
            <span class="text-xs bg-indigo-100 text-indigo-600 px-2 py-0.5 rounded-full font-medium">Template-Based</span>
        </div>
        <div class="space-y-4">
