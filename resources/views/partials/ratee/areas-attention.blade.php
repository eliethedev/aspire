...
<div class="bg-white dark:bg-gray-900 rounded-2xl border border-slate-200 dark:border-gray-800 shadow-sm p-6 section-card">
    ...
    @if($insufficient)
        <div class="flex items-start gap-3 rounded-xl border border-slate-200 dark:border-gray-700 bg-slate-50 dark:bg-gray-800 p-4">
            <div class="w-8 h-8 rounded-xl bg-white dark:bg-gray-900 border border-slate-200 dark:border-gray-700 flex items-center justify-center shrink-0"><i class="fas fa-circle-info text-slate-400 dark:text-gray-500 text-sm"></i></div>
            <div>
                <p class="text-sm font-semibold text-slate-800 dark:text-gray-100">Not enough observation data yet.</p>
                <p class="text-xs text-slate-500 dark:text-gray-400 mt-1">A clearer picture appears after more scored observations.</p>
            </div>
        </div>
    ...
    @else
        ...
        <p class="text-xs text-slate-500 dark:text-gray-400 mt-4 flex items-center gap-1.5"><i class="fas fa-lightbulb text-amber-500"></i> Consider a coaching conversation to support growth in these areas.</p>
    @endif
</div>
