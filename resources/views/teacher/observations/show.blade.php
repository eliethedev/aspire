...
@if(session('success'))
    <div class="max-w-7xl mx-auto px-6 mb-4">
        <div class="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 text-green-800 dark:text-green-400 rounded-xl px-5 py-3 text-sm flex items-center gap-2">
...
@if(session('error'))
    <div class="max-w-7xl mx-auto px-6 mb-4">
        <div class="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 text-red-800 dark:text-red-400 rounded-xl px-5 py-3 text-sm flex items-center gap-2">
            ...
            <div class="space-y-2.5">
                @foreach($observation->cotRatings as $rating)
                    @php
                        ...
                        $rPct = $r ? ($r / 6) * 100 : 0;
                        $rColor = !$r ? 'bg-gray-100 dark:bg-gray-800 border-gray-200 dark:border-gray-700' : ($r >= 5 ? 'border-emerald-200 dark:border-emerald-800 bg-emerald-50 dark:bg-emerald-900/20' : ($r >= 4 ? 'border-blue-200 dark:border-blue-800 bg-blue-50 dark:bg-blue-900/20' : ($r >= 3 ? 'border-amber-200 dark:border-amber-800 bg-amber-50 dark:bg-amber-900/20' : 'border-red-200 dark:border-red-800 bg-red-50 dark:bg-red-900/20')));
                        $rBadge = !$r ? 'bg-gray-100 dark:bg-gray-700 text-gray-500 dark:text-gray-400' : ($r >= 5 ? 'bg-emerald-100 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-400' : ($r >= 4 ? 'bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400' : ($r >= 3 ? 'bg-amber-100 dark:bg-amber-900/30 text-amber-700 dark:text-amber-400' : 'bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-400')));
                    @endphp
