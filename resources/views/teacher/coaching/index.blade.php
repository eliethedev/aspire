...
<div class="max-w-7xl mx-auto px-4 sm:px-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Improvement Plan</h1>
            <p class="text-gray-500 mt-1">Coaching agreements and action plans from your observations.</p>
        </div>
    </div>
    ...
    @if($agreements->isEmpty())
        <div class="bg-white rounded-xl border border-gray-100 shadow-sm p-12 text-center">
            ...
            <h3 class="text-lg font-semibold text-gray-900 mb-1">No Improvement Plans Yet</h3>
            <p class="text-sm text-gray-500">Coaching agreements from your supervisor will appear here once created.</p>
        </div>
    @else
        <div class="space-y-4">
                    ...
                    <div class="p-5">
                        <div class="flex items-center justify-between mb-3">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <p class="text-sm font-semibold text-gray-900">Coaching Agreement</p>
                                    <p class="text-xs text-gray-500">{{ $obs->observation_date->format('M d, Y') }} &middot; {{ $agreement->supervisor?->name ?? 'Supervisor' }}</p>
                                </div>
                            </div>
