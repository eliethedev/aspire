...
<head>
    ...
    <style>
        ...
        .dark select.light-input option {
...
<body class="antialiased font-sans light-bg min-h-screen flex items-center justify-center p-4 relative overflow-none">
    ...
    <div class="w-full max-w-md glass-card rounded-2xl p-8 md:p-10 relative z-10">
        ...
        <form method="POST" action="{{ route('register') }}" class="space-y-5">
            ...
            <!-- Name Field -->
            <div>
                <label class="block text-sm font-semibold text-gray-700 dark:text-gray-200 mb-2">Full Name</label>
                <input 
                    type="text" 
                    name="name" 
                    value="{{ old('name') }}"
            ...
            <!-- School Field -->
            <div>
                <label class="block text-sm font-semibold text-gray-700 dark:text-gray-200 mb-2">School</label>
                <select name="school_id" class="light-input w-full px-4 py-3 rounded-xl" required>
                    <option value="" class="bg-white dark:bg-gray-800">Select School</option>
                    @foreach($schools ?? [] as $school)
                        <option value="{{ $school->id }}" {{ old('school_id') == $school->id ? 'selected' : '' }} class="bg-white dark:bg-gray-800">{{ $school->name }}</option>
                    @endforeach
                </select>
                @error('school_id')
                    <p class="mt-2 text-sm text-rose-400 flex items-center">
            ...
            <div class="space-y-5">
                ...
                <div>
                    <label class="block text-sm font-semibold text-gray-700 dark:text-gray-200 mb-2">Years of Service</label>
                    <input 
                        type="number" 
                ...
                <div>
                    <label class="block text-sm font-semibold text-gray-700 dark:text-gray-200 mb-2">Mobile Number</label>
                    <input 
                        type="text" 
                        name="mobile_number" 
                ...
                <div>
                    <label class="block text-sm font-semibold text-gray-700 dark:text-gray-200 mb-2">Employee Number (Optional)</label>
                    <input 
                        type="text" 
                ...
                <div>
                    <label class="block text-sm font-semibold text-gray-700 dark:text-gray-200 mb-2">PRC License Number (Optional)</label>
                    <input 
                        type="text" 
                ...
                <div>
                    <label class="block text-sm font-semibold text-gray-700 dark:text-gray-200 mb-2">Position (Optional)</label>
                    <input 
                        type="text" 
                        name="position" 
                        value="{{ old('position') }}"
        ...
        <div class="relative my-8">
            ...
            <div class="relative flex justify-center text-xs uppercase">
                <span class="bg-white dark:bg-gray-900 px-3 text-gray-400 dark:text-gray-500 font-medium">Or continue with</span>
            </div>
        </div>
        ...
        <div class="grid grid-cols-2 gap-3 mb-8">
            <button 
                type="button" 
                class="flex items-center justify-center px-4 py-2.5 border border-gray-200 dark:border-gray-700 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-800 hover:border-gray-300 transition-all duration-200 group"
            >
                <svg class="w-5 h-5 text-gray-500 dark:text-gray-400 group-hover:text-gray-700 dark:group-hover:text-gray-200 group-hover:scale-110 transition-all" viewBox="0 0 24 24" fill="currentColor">
            ...
            <button 
                ...
                class="flex items-center justify-center px-4 py-2.5 border border-gray-200 dark:border-gray-700 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-800 hover:border-gray-300 transition-all duration-200 group"
            >
                <svg class="w-5 h-5 text-gray-500 dark:text-gray-400 group-hover:text-gray-700 dark:group-hover:text-gray-200 group-hover:scale-110 transition-all" fill="currentColor" viewBox="0 0 24 24">
