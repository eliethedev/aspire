...
<div class="obs-show max-w-7xl mx-auto px-6">
            ...
            @foreach($stageKeys as $i => $key)
                ...
                @else
                    <div class="flex items-center opacity-50">
                        <div class="flex items-center justify-center w-10 h-10 rounded-full bg-gray-200 dark:bg-gray-700 text-gray-400 dark:text-gray-500 font-semibold text-sm">
                            {{ $i + 1 }}
                        </div>
        ...
        @foreach($stageKeys as $i => $key)
            ...
            @else
                <div class="bg-gray-50 dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm p-4 opacity-60">
                    <div class="flex items-center gap-3 mb-2">
                        <div class="w-9 h-9 rounded-lg bg-gray-200 dark:bg-gray-700 text-gray-400 dark:text-gray-500 flex items-center justify-center">
                            {!! $icon !!}
                        </div>
    ...
    <div class="space-y-6">
        ...
        <div class="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-100 dark:border-gray-800 p-6">
                    ...
                    <div class="divide-y divide-gray-100 dark:divide-gray-800">
                        ...
                        <div class="px-4 py-2.5 flex items-center justify-between gap-4">
                            ...
                            <span class="inline-flex items-center justify-center w-8 h-8 rounded-full text-xs font-bold shrink-0
                                {{ $rating->rating >= 4 ? 'bg-green-100 dark:bg-green-500/10 text-green-700 dark:text-green-300' : ($rating->rating >= 3 ? 'bg-yellow-100 dark:bg-yellow-500/10 text-yellow-700 dark:text-yellow-300' : 'bg-red-100 dark:bg-red-500/10 text-red-700 dark:text-red-300') }}">
                                {{ $rating->rating }}
                            </span>
                            @else
                            <span class="inline-flex items-center justify-center w-8 h-8 rounded-full text-xs font-bold bg-gray-100 dark:bg-gray-800 text-gray-400 dark:text-gray-500 shrink-0">—</span>
                            @endif
                        </div>
                        @endforeach
                    </div>
            ...
            <div class="mt-4 p-4 rounded-xl bg-gray-50 dark:bg-gray-800 border border-gray-100 dark:border-gray-800">
            ...
            <div class="mt-3 p-4 rounded-xl bg-gray-50 dark:bg-gray-800 border border-gray-100 dark:border-gray-800">
