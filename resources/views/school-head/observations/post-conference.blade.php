...
<div class="max-w-7xl mx-auto px-6">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <form method="POST" action="{{ route('school-head.observations.storePostConference', $observation) }}" class="space-y-6"
...
document.getElementById('generate-ai-comparison-btn')?.addEventListener('click', function() {
    ...
    fetch('{{ route("school-head.observations.generate-ai-comparison", $observation) }}', {
        method: 'POST',
        headers: {
