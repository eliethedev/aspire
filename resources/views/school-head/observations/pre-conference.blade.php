...
<div class="max-w-7xl mx-auto px-6">
    ...
    <form method="POST" action="{{ route('school-head.observations.storePreConference', $observation) }}" id="pre-conference-form" class="space-y-6"
            ...
            <div id="ai-insights-panel"
                ...
                <div class="flex items-center justify-between p-4 border-b border-purple-100 bg-gradient-to-r from-purple-50 to-indigo-50 rounded-t-xl">
                    <div class="flex items-center gap-2">
                        ...
                        <h2 class="text-lg font-semibold text-gray-900 dark:text-gray-100">AI Pre-Observation Insights</h2>
                        <span class="text-xs bg-purple-100 dark:bg-purple-900/30 text-purple-700 px-2 py-0.5 rounded-full font-medium">AI-Powered</span>
                        @if($aiReviewed)
                    ...
                    <div class="p-4 pt-0 border-t border-gray-100">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="bg-green-50 dark:bg-green-900/20 rounded-lg p-3 border border-green-100">
                                <span class="text-xs text-gray-500 dark:text-gray-400 uppercase tracking-wider font-medium">Observation Tool</span>
...
<div id="cancel-modal" class="fixed inset-0 z-50 hidden items-center justify-center modal-overlay">
    <div class="bg-white dark:bg-gray-900 rounded-xl shadow-2xl max-w-md w-full mx-4 p-6">
        ...
        <form method="POST" action="{{ route('school-head.observations.cancel', $observation) }}">
            @csrf
            <div class="mb-4">
...
function useAiSuggestions() {
    ...
    .then(function(result) {
        if (result.ok && (result.data.discussion_notes || result.data.finalized_focus)) {
            ...
            alert('No AI suggestions available. Please try again or write your own notes.');
        }
    })
    .catch(function() {
