                ...
                <div class="bg-white dark:bg-gray-900 rounded-xl shadow-sm p-6 border border-gray-100">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="bg-indigo-50 dark:bg-indigo-900/30 rounded-lg p-3 border border-indigo-200 dark:border-indigo-900/50">
                            <p class="text-sm font-semibold text-indigo-800 dark:text-indigo-300">EPOC</p>
                            <p class="text-xs text-indigo-600 dark:text-indigo-400 mt-1">Evaluation of Practices and Observation of Competencies — used for School Head observations.</p>
                        </div>
                    </div>
                    @else
                    <div class="mb-4">
