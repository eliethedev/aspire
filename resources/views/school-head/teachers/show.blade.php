...
<div class="mock-wrap max-w-7xl mx-auto px-1 py-1">
    <div class="mock-topbar">
        <div class="mock-crumbs">School Head <span>/</span> <b>Teacher Profile</b></div>
        <span class="mock-pill"><span class="pulse"></span>Teacher record</span>
        <div class="mock-actions">
            <a class="mock-btn" href="{{ route('school-head.teachers.index') }}">Back to Teachers</a>
        </div>
    </div>
    ...
    <div class="mock-title">
        <div>
            ...
            <p>Teacher profile and observation history</p>
        </div>
    ...
    <div class="mock-panel bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm p-6 mb-6">
        ...
        <dl class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-5">
            ...
            <div>
                ...
                <dd class="mt-1 text-sm font-semibold text-gray-900 dark:text-gray-100">{{ $teacher->grade_level ? $teacher->grade_level_label : '--' }}</dd>
            </div>
            <div>
    ...
    <div class="mock-kpis grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
